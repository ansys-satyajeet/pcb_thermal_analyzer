...
to automate engineering simulation workflows using Ansys tools.
''')
...
link_pyaedt = '[Learn more about PyAEDT](https://aedt.docs.pyansys.com/)'
...
**Requirements**:
* A licensed copy of Ansys Electronics Desktop 2023R1 or above must be installed on the machine running the simulation.
